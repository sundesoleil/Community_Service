	...
	<div class="content_wrap">
		...
		<div class="comment_area">
			...
			<%-- <c:forEach items = "${comments }" var="comment">
				<div class="comment" style="border:1px solid gray; margin-bottom:10px;">
					<div>
						<span>${comment.ui_name }</span>
						<span>
						<fmt:formatDate value="${comment.ci_reg_dt }" pattern="yyyy-MM-dd HH:mm"/>
						</span>
						<div class="likes">
							<span class="like_cnt">
